							...
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu">
											<li><a href="/myframework/<?php echo (CONTROLLER_NAME); ?>/viewModify/m_id/<?php echo I('m_id');?>/p_id/<?php echo I('p_id');?>/id/<?php echo ($vo["id"]); ?>" class="fa fa-edit"> 修改基本信息</a></li>
											<li class="divider"></li>
...
<script type="text/javascript">
	var deleteUrl = "/myframework/<?php echo (CONTROLLER_NAME); ?>/deleteInterface/";
