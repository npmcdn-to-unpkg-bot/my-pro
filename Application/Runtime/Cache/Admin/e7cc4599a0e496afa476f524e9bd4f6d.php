		...
		<div class="span12">
			...
			<div class="widget-box">
				<div class="widget-title" style="padding: 5px">
					...
					<a href="/my-pro/<?php echo (CONTROLLER_NAME); ?>/viewAdd/m_id/<?php echo I('m_id');?>/p_id/<?php echo I('p_id');?>"><button class="btn btn-success  fr fa fa-plus">新增</button></a>
				</div>
					...
					<table class="table table-bordered  table-striped with-check">
						...
						<tbody>
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><?php if($vo["int_method"] == '00A'): ?>GET方式
								<?php elseif($vo["int_method"] == '00B'): ?>POST方式<?php endif; ?></td>
								...
								<td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu">
											<li><a href="/my-pro/<?php echo (CONTROLLER_NAME); ?>/viewModify/m_id/<?php echo I('m_id');?>/p_id/<?php echo I('p_id');?>/id/<?php echo ($vo["id"]); ?>" class="fa fa-edit"> 修改基本信息</a></li>
											<li class="divider"></li>
											<li><a href="<?php echo U('interParams' , array('m_id' => I('m_id'), 'p_id' => I('p_id'), 'intId' => $vo['id'] , 'type' => 'paramIn'));?>" class="fa fa-indent"> 入参管理</a></li>
											<li><a href="<?php echo U('interParams' , array('m_id' => I('m_id'), 'p_id' => I('p_id'), 'intId' => $vo['id'] , 'type' => 'paramOut'));?>" class="fa fa-dedent"> 出参管理</a></li>
											<li><a href="<?php echo U('interParams' , array('m_id' => I('m_id'), 'p_id' => I('p_id'), 'intId' => $vo['id'], 'type' => 'errorCode'));?>" class="fa fa-times-circle"> Code管理</a></li>
											<li class="divider"></li>
											<li><a href="<?php echo U('viewDetails' , array('m_id' => I('m_id'), 'p_id' => I('p_id'), 'id' => $vo['id']));?>" class="fa fa-tasks">详情</a></li>
											<li class="divider"></li>
				...
				<div id="mySearch" class="modal hide">
					...
					<div class="modal-body">
						<form action="/my-pro/<?php echo (CONTROLLER_NAME); ?>/viewList/" method="get" id="searchFrom" class="form-horizontal">
							<div class="control-group">
...
<script type="text/javascript">
	var deleteUrl = "/my-pro/<?php echo (CONTROLLER_NAME); ?>/deleteInterface/";
