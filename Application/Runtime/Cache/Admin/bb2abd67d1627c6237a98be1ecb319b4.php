		...
		<div class="span12">
			<div class="widget-box">
				...
				<form class="form-horizontal" method="post"
					action="/myframework/<?php echo (CONTROLLER_NAME); ?>/add" name="interface"
					id="interface_validate" novalidate="novalidate">
							...
							<div class="control-group">
								...
								<div class="controls">
									<select name="category" id="category" class="span5" >
										...
										<?php if(is_array($catData)): $i = 0; $__LIST__ = $catData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$top): $mod = ($i % 2 );++$i;?><option value="<?php echo ($top["id"]); ?>/<?php echo ($top["name"]); ?>"><?php echo ($top["name"]); ?></option>
										<?php if(is_array($top["children"])): $i = 0; $__LIST__ = $top["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$chls): $mod = ($i % 2 );++$i;?><option value="<?php echo ($chls["id"]); ?>/<?php echo ($chls["name"]); ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;----<?php echo ($chls["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
							</div>
