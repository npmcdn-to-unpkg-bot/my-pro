...
<!-- 引入样式表 -->
<link rel="stylesheet" type="text/css" href="/git/my-pro/Public/StyleResources/Bootstrap/bootstrap.min.css" />
<link rel="stylesheet" type="text/css" href="/git/my-pro/Public/StyleResources/Bootstrap/bootstrap-responsive.min.css" />
<link rel="stylesheet" type="text/css" href="/git/my-pro/Public/StyleResources/Matrix/matrix-style.css" />
<link rel="stylesheet" type="text/css" href="/git/my-pro/Public/StyleResources/Matrix/matrix-media.css" />

<?php switch($PAGE_FROM): case "Index": ?><link rel="stylesheet" type="text/css" href="/git/my-pro/Public/StyleResources/fullcalendar.css" />
		<link rel="stylesheet" type="text/css" href="/git/my-pro/Public/StyleResources/Matrix/matrix-media.css/jquery.gritter.css" /><?php break;?>
	<?php case "List": case "Add": ?><link rel="stylesheet" type="text/css" href="/git/my-pro/Public/StyleResources/uniform.css" />
		<link rel="stylesheet" type="text/css" href="/git/my-pro/Public/StyleResources/select2.css" /><?php break; endswitch;?>
<link rel="stylesheet" type="text/css" href="/git/my-pro/Public/StyleResources/font-awesome-4.4.0/css/font-awesome.css" />
<!-- <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,700,800' rel='stylesheet' type='text/css'> -->
<script type="text/javascript">
var urlHead="/git/my-pro/<?php echo (CONTROLLER_NAME); ?>/";
</script>
...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class=""><a title="" href="/git/my-pro/index/logout"><i class="fa fa-share-alt"></i> <span class="text">安全退出</span></a></li>
  </ul>
</div>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="fa fa-home"></i> Dashboard</a>
	...
	<li <?php if(I('p_id') == "" || I('p_id') == null){?>class="active"<?php }?>><a href="/git/my-pro/index/index"><i class="fa fa-home"></i> <span>首页</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> 
	    <a href="/git/my-pro/Index/Index" title="Go to Home" class="tip-bottom"><i class="fa-home"></i> 首页</a>
...
<!-- 高级搜索弹出框 begin -->
				<div id="setting" class="modal hide">
					...
					<div class="modal-body">
						<form action="/git/my-pro/Admins/setPsw/" method="post" id="setPswForm" class="form-horizontal">
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding collapse in" id="collapseG2">
            <ul class="recent-posts">
              <li>
                <div class="user-thumb"> <img width="40" height="40" alt="User" src="/git/my-pro/Public/ImgResources/Admin/img/demo/av1.jpg"> </div>
                <div class="article-post"> <span class="user-info"> By: john Deo / Date: 2 Aug 2012 / Time:09:27 AM </span>
                  <p><a href="#">This is a much longer one that will go on for a few lines.It has multiple paragraphs and is full of waffle to pad out the comment.</a> </p>
                </div>
              </li>
              <li>
                <div class="user-thumb"> <img width="40" height="40" alt="User" src="/git/my-pro/Public/ImgResources/Admin/img/demo/av2.jpg"> </div>
                <div class="article-post"> <span class="user-info"> By: john Deo / Date: 2 Aug 2012 / Time:09:27 AM </span>
                  <p><a href="#">This is a much longer one that will go on for a few lines.It has multiple paragraphs and is full of waffle to pad out the comment.</a> </p>
                </div>
              </li>
              <li>
                <div class="user-thumb"> <img width="40" height="40" alt="User" src="/git/my-pro/Public/ImgResources/Admin/img/demo/av4.jpg"> </div>
                <div class="article-post"> <span class="user-info"> By: john Deo / Date: 2 Aug 2012 / Time:09:27 AM </span>
            ...
            <div class="chat-users panel-right2">
              ...
              <div class="panel-content nopadding">
                <ul class="contact-list">
                  <li id="user-Alex" class="online"><a href="#"><img alt="" src="/git/my-pro/Public/ImgResources/Admin/img/demo/av1.jpg" /> <span>Alex</span></a></li>
                  <li id="user-Linda"><a href="#"><img alt="" src="/git/my-pro/Public/ImgResources/Admin/img/demo/av2.jpg" /> <span>Linda</span></a></li>
                  <li id="user-John" class="online new"><a href="#"><img alt="" src="/git/my-pro/Public/ImgResources/Admin/img/demo/av3.jpg" /> <span>John</span></a><span class="msg-count badge badge-info">3</span></li>
                  <li id="user-Mark" class="online"><a href="#"><img alt="" src="/git/my-pro/Public/ImgResources/Admin/img/demo/av4.jpg" /> <span>Mark</span></a></li>
                  <li id="user-Maxi" class="online"><a href="#"><img alt="" src="/git/my-pro/Public/ImgResources/Admin/img/demo/av5.jpg" /> <span>Maxi</span></a></li>
                </ul>
              </div>
            </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content tab-content">
            <div id="tab1" class="tab-pane active">
              ...
              <img src="/git/my-pro/Public/ImgResources/Admin/img/demo/demo-image1.jpg" alt="demo-image"/></div>
            <div id="tab2" class="tab-pane"> <img src="/git/my-pro/Public/ImgResources/Admin/img/demo/demo-image2.jpg" alt="demo-image"/>
              <p>And is full of waffle to It has multiple paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end.multiple paragraphs and is full of waffle to pad out the comment.</p>
            </div>
            <div id="tab3" class="tab-pane">
              <p>And is full of waffle to It has multiple paragraphs and is full of waffle to pad out the comment. Usually, you just wish these sorts of comments would come to an end.multiple paragraphs and is full of waffle to pad out the comment. </p>
              <img src="/git/my-pro/Public/ImgResources/Admin/img/demo/demo-image3.jpg" alt="demo-image"/></div>
          </div>
        </div>
      </div>
    </div>
...
<script src="/git/my-pro/Public/JsResources/Jquery/jquery.min.js"></script> 
<script src="/git/my-pro/Public/JsResources/Jquery/jquery.ui.custom.js"></script> 
<script src="/git/my-pro/Public/JsResources/Bootstrap/bootstrap.min.js"></script> 
<script src="/git/my-pro/Public/JsResources/Jquery/jquery.uniform.js"></script> 
<script src="/git/my-pro/Public/JsResources/Jquery/jquery.dataTables.min.js"></script> 
<script src="/git/my-pro/Public/JsResources/Matrix/matrix.js"></script> 
<script src="/git/my-pro/Public/JsResources/Matrix/matrix.tables.js"></script> 
 <?php switch($PAGE_FROM): case "Index": ?><script src="/git/my-pro/Public/JsResources/excanvas.min.js"></script> 
		<script src="/git/my-pro/Public/JsResources/Jquery/jquery.flot.min.js"></script> 
		<script src="/git/my-pro/Public/JsResources/Jquery/jquery.flot.resize.min.js"></script> 
		<script src="/git/my-pro/Public/JsResources/Jquery/jquery.peity.min.js"></script> 
		<script src="/git/my-pro/Public/JsResources/fullcalendar.min.js"></script> 
		<script src="/git/my-pro/Public/JsResources/Matrix/matrix.dashboard.js"></script> 
		<script src="/git/my-pro/Public/JsResources/Matrix/jquery.gritter.min.js"></script> 
		<script src="/git/my-pro/Public/JsResources/Matrix/matrix.interface.js"></script> 
		<script src="/git/my-pro/Public/JsResources/Matrix/matrix.chat.js"></script> 
		<script src="/git/my-pro/Public/JsResources/Jquery/jquery.validate.js"></script> 
		<script src="/git/my-pro/Public/JsResources/Matrix/matrix.form_validation.js"></script> 
		<script src="/git/my-pro/Public/JsResources/Jquery/Jquery.wizard.js"></script> 
		<script src="/git/my-pro/Public/JsResources/select2.min.js"></script> 
		<script src="/git/my-pro/Public/JsResources/Matrix/matrix.popover.js"></script><?php break;?>
 	<?php case "List": ?><script src="/git/my-pro/Public/JsResources/select2.min.js"></script> 
		<script src="/git/my-pro/Public/JsResources/Matrix/matrix.interface.js"></script> 
		<script src="/git/my-pro/Public/JsResources/list-opration.js"></script><?php break;?>
 	<?php case "Add": ?><script src="/git/my-pro/Public/JsResources/Jquery/jquery.validate.js"></script> 
 		<script src="/git/my-pro/Public/JsResources/select2.min.js"></script> 
 		<script src="/git/my-pro/Public/JsResources/Matrix/matrix.form_validation.js"></script> 
 		<script src="/git/my-pro/Public/JsResources/Matrix/matrix.form_common.js"></script> 
		<script src="/git/my-pro/Public/JsResources/iconSelect.js"></script><?php break; endswitch;?>
