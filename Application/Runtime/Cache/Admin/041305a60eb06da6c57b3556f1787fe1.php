		...
		<div class="span12">
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					<form class="form-horizontal" method="post" action="/myframework/<?php echo (CONTROLLER_NAME); ?>/menuadd" name="menu" id="menu_validate" novalidate="novalidate">
						<div class="control-group">
							<label class="control-label">菜单名称</label>
							<div class="controls">
								<input type="text" class="span5" name="menu_name" id="menu_name" placeholder="请输入菜单名称(必填)" />
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<select  name="pid" id="pid" class="span5">
									<option value="none">我就是父菜单</option>
									<?php if(is_array($mainMenu)): $i = 0; $__LIST__ = $mainMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>/<?php echo ($vo["menu_name"]); ?>"><?php echo ($vo["menu_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="uri" id="uri" class="span5" placeholder="请输入菜单资源URI" />
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="hidden" name="icon" id="icon" value="" /> <a href="#myIcons" data-toggle="modal"><button class="btn"><i class="icon" style="margin-right: 20px;" id="selectedI"></i>点击选择</button></a>
							</div>
						</div>
