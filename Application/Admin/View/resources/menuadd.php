		...
		<div class="span12">
			<div class="widget-box">
				...
				<div class="widget-content nopadding">
					<form class="form-horizontal" method="post" action="__ROOT__/{$Think.CONTROLLER_NAME}/menuadd" name="menu" id="menu_validate" novalidate="novalidate">
						...
						<div class="control-group">
							...
							<div class="controls">
								<select  name="pid" id="pid" class="span5">
									...
									<option value="{$vo.id}/{$vo.menu_name}">{$vo.menu_name}</option>
									</volist>
								</select>
							</div>
						</div>
