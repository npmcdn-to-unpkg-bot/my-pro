...
function(e) {
    ...
    t.prototype = {
        ...
        pause: function(t) {
            ...
            this.$element.find(".next, .prev").length && e.support.transition.end && (this.$element.trigger(e.support.transition.end), this.cycle()),
    ...
    e.fn.carousel = function(n) {
        return this.each(function() {
            ...
            typeof n == "number" ? i.to(n) : o ? i[o]() : s.interval && i.cycle()
        })
    },
    ...
    e(document).on("click.carousel.data-api", "[data-slide]",
    function(t) {
        var n = e(this),
        r,
...
function(e) {
    ...
    function(t) {
        ...
        e(i).collapse(s)
        //姚远自增
        var ic = n.children('span').children('i');
        if(e(i).hasClass("in") ){
        	ic.removeClass('icon-double-angle-down');
        	ic.addClass('icon-double-angle-up');
        }
        else if(!e(i).hasClass("in") ){
        	ic.removeClass('icon-double-angle-up');
        	ic.addClass('icon-double-angle-down');
        }
    })
} (window.jQuery),
!
...
function(e) {
    ...
    t.prototype = {
        ...
        init: function(t, n, r) {
            ...
            this.enabled = !0,
            this.options.trigger == "click" ? this.$element.on("click." + this.type, this.options.selector, e.proxy(this.toggle, this)) : this.options.trigger != "manual" && (i = this.options.trigger == "hover" ? "mouseenter": "focus", s = this.options.trigger == "hover" ? "mouseleave": "blur", this.$element.on(i + "." + this.type, this.options.selector, e.proxy(this.enter, this)), this.$element.on(s + "." + this.type, this.options.selector, e.proxy(this.leave, this))),
        ...
        getOptions: function(t) {
            return t = e.extend({},
            e.fn[this.type].defaults, t, this.$element.data()),
...
function(e) {
    ...
    e.fn.tooltip.Constructor.prototype, {
        ...
        getContent: function() {
            var e, t = this.$element,
            n = this.options;
            return e = t.attr("data-content") || (typeof n.content == "function" ? n.content.call(t[0]) : n.content),
            e
        },
        tip: function() {
            return this.$tip || (this.$tip = e(this.options.template)),
