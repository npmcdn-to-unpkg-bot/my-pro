    ...
    a.fn.extend({
        caret: function(a, b) {
            if (this.length != 0) {
                ...
                if (this[0].setSelectionRange) a = this[0].selectionStart,
        ...
        mask: function(d, e) {
            ...
            return this.trigger("unmask").each(function() {
                    ...
                    if (b) {
                        ...
                        if (d < k) {
                            ...
                            if (h[d].test(g)) {
                                ...
                                var i = n(d);
                                f.caret(i),
                                e.completed && i >= k && e.completed.call(f)
                            }
                        }
                        return ! 1
                    }
                ...
                function() {
                    v(),
                    f.val() != m && f.change()
                }).bind("keydown.mask", r).bind("keypress.mask", s).bind(b,
                function() {
                    setTimeout(function() {
                        f.caret(v(!0))
                    },
